...
Estás a falar por WhatsApp — mantém as respostas curtas (2-4 frases), como uma conversa normal de WhatsApp. Não uses markdown (nada de **negrito** ou # títulos) — no WhatsApp isso aparece com os símbolos à mostra. Se precisares de destacar algo, usa *asterisco simples* (é assim que o WhatsApp mostra negrito nativamente) em vez de duplo.
